...
<?php include('navbar_books.php'); ?>
    <div class="container">
     ...
     <input type="submit" name="export" class="btn btn-success" value="Export" />
								...
								<p><a href="add_books.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Single Books</a></p>
								<p><a href="ok.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Multiple Books</a></p>
                                ...
                                <tbody>
								  ...
								  $user_query=mysql_query("select * from book where status != 'Archive'")or die(mysql_error());
									...
									@$total =  $book_copies  -  $count-$lcount-$dcount; 
