...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
	    ...
	    <div class="control-group">
					...
					<div class="controls">
					<input type="text" name="publisher" id="inputPassword" placeholder="Publisher">
					</div>
					</div>	
	    
	    <div class="control-group">
					<label class="control-label" for="inputPassword">Accession No.</label>
					<div class="controls">
					<input type="text" name="accno" id="inputPassword" placeholder="Accession No.">
					</div>
					</div>	
